...
class PagingAdapterAnime ( private var onPosterClick: (movieResult: AnimeDetail) -> Unit): PagingDataAdapter<AnimeDetail, PagingAdapterAnime.ListviewHolder>(COMPARATOR) {
